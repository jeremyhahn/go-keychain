...
func TestCompositeKeyStore_Close(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			backendCloseError: xkms.ErrBackendClosed,
			storageCloseError: nil,
			expectError:       true,
		},
		{
			...
			backendCloseError: nil,
			storageCloseError: xkms.ErrStorageClosed,
			expectError:       true,
		},
	}
