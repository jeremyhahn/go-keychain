...
// Package xkms provides a unified interface for secure cryptographic key management
...
// # Overview
//
// The xkms package abstracts the complexity of different key storage mechanisms
...
// # Key Concepts
//
// Backend: The primary interface for all key operations. Implementations handle
// the details of interacting with specific key providers.
//
...
//
// KeyProvider: The underlying storage mechanism. Can be file-based, hardware-backed,
// or TPM-based.
//
...
// # Basic Usage
//
// Create a xkms backend and generate a key:
//
//	cfg := &xkms.BackendConfig{
//	    StoreType: xkms.StorePKCS8,
...
// # Thread Safety
//
// Backend implementations are expected to be safe for concurrent use. However,
