...
func (s *GRPCServer) Start() error {
	...
	s.logger.Info("gRPC Unix socket created", slog.String("path", s.config.SocketPath))
	...
	s.logger.Info("Starting gRPC Unix socket server", slog.String("socket", s.config.SocketPath))
