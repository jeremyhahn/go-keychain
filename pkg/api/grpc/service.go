...
// Note: Key versioning requires a VersioningAdapter to be configured.
// This is currently a placeholder that returns unimplemented.
func (s *Service) ListKeyVersions(ctx context.Context, req *pb.ListKeyVersionsRequest) (*pb.ListKeyVersionsResponse, error) {
	// Key versioning is not yet integrated into the KeychainService.
	// The VersioningAdapter interface exists in pkg/adapters/versioning but
	// needs to be wired into the backend layer.
	return nil, status.Error(codes.Unimplemented, "key versioning is not yet supported - requires VersioningAdapter integration")
}

// EnableKeyVersion enables a specific version of a key
func (s *Service) EnableKeyVersion(ctx context.Context, req *pb.EnableKeyVersionRequest) (*pb.EnableKeyVersionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "key versioning is not yet supported - requires VersioningAdapter integration")
}

// DisableKeyVersion disables a specific version of a key
func (s *Service) DisableKeyVersion(ctx context.Context, req *pb.DisableKeyVersionRequest) (*pb.DisableKeyVersionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "key versioning is not yet supported - requires VersioningAdapter integration")
}

// EnableAllKeyVersions enables all versions of a key
func (s *Service) EnableAllKeyVersions(ctx context.Context, req *pb.EnableAllKeyVersionsRequest) (*pb.EnableAllKeyVersionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "key versioning is not yet supported - requires VersioningAdapter integration")
}

// DisableAllKeyVersions disables all versions of a key
func (s *Service) DisableAllKeyVersions(ctx context.Context, req *pb.DisableAllKeyVersionsRequest) (*pb.DisableAllKeyVersionsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "key versioning is not yet supported - requires VersioningAdapter integration")
}
...
func (s *Service) CanSeal(ctx context.Context, req *pb.CanSealRequest) (*pb.CanSealResponse, error) {
	...
	if req.Backend != "" {
		canSeal = keychain.CanSeal(req.Backend)
	} else {
