...
const (
	...
	infoOpeningDevice          = "tpm: opening Linux TPM 2.0 Device"
	infoOpeningPlatformAddress = "tpm: opening TPM 2.0 TCP connection"
...
var (
	...
	// ECC P384 Template
	ECCP384Template = tpm2.TPMTPublic{
		Type:    tpm2.TPMAlgECC,
	...
	// ECC P521 Template
	ECCP521Template = tpm2.TPMTPublic{
		Type:    tpm2.TPMAlgECC,
