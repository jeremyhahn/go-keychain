...
/*
Package audit provides an adapter pattern for audit logging in go-xkms.

# Overview

The audit adapter pattern allows applications to implement custom audit trail
strategies while maintaining a consistent interface throughout go-xkms.
...
The audit adapter integrates with go-xkms's middleware and
