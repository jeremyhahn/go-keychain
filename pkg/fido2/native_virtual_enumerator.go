...
// Ensure nativeVirtualDeviceWrapper implements HIDDevice.
var _ HIDDevice = (*nativeVirtualDeviceWrapper)(nil)

// NativeVirtualDeviceEnumerator implements HIDDeviceEnumerator for NativeVirtualDevice.
...
func (e *NativeVirtualDeviceEnumerator) Enumerate(vendorID, productID uint16) ([]HIDDevice, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
...
// to be reused across multiple operations.
func (e *NativeVirtualDeviceEnumerator) Open(path string) (HIDDevice, error) {
	e.mu.RLock()
	defer e.mu.RUnlock()
...
// Ensure NativeVirtualDeviceEnumerator implements HIDDeviceEnumerator.
var _ HIDDeviceEnumerator = (*NativeVirtualDeviceEnumerator)(nil)
