...
const (
	...
	NativeVirtualDeviceProductID uint16 = 0x0002 // Distinct from VirtualFIDO2Device
...
// NativeVirtualDevice implements HIDDevice using the native Go authenticator.
...
// Ensure NativeVirtualDevice implements HIDDevice.
var _ HIDDevice = (*NativeVirtualDevice)(nil)
