...
// Package frost provides FROST threshold signature support for go-xkms.
//
// This package implements RFC 9591 FROST (Flexible Round-Optimized Schnorr
// Threshold Signatures) as a go-xkms backend. FROST enables threshold
...
//   - SecretBackend: Stores the secret key share using any types.KeyProvider
