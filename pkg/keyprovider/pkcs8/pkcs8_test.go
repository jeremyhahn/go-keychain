...
func TestClose(t *testing.T) {
	...
	_, err = storage.ListKeys(context.Background(), keyStorage)
	if err == nil {
...
func TestInterfaceCompliance(t *testing.T) {
	var _ types.KeyProvider = (*PKCS8Backend)(nil)
}
...
func TestPublic_UnsupportedKeyType(t *testing.T) {
	...
	keyID := attrs.ID()
	err := storage.SaveKey(context.Background(), be.storage, keyID, []byte("invalid key data"))
	if err != nil {
...
func (m *mockStorageError) Delete(_ context.Context, key string) error {
	if m.deleteError {
...
func (m *mockStorageError) Put(_ context.Context, key string, value []byte) error {
	if m.saveError {
		return fmt.Errorf("mock save error")
	}
	return m.Backend.Put(context.Background(), key, value)
}

func (m *mockStorageError) List(_ context.Context, prefix string) ([]string, error) {
	if m.listError {
...
func (m *mockStorageError) KeyExists(_ context.Context, id string) (bool, error) {
	return false, nil
}

func (m *mockStorageError) GetKey(_ context.Context, id string) ([]byte, error) {
...
func (m *mockStorageErrorOnExists) Exists(_ context.Context, key string) (bool, error) {
	return false, fmt.Errorf("mock Exists error")
}

func (m *mockStorageErrorOnExists) Put(_ context.Context, key string, value []byte) error {
	return nil
}

func (m *mockStorageErrorOnExists) GetKey(_ context.Context, id string) ([]byte, error) {
	return nil, storage.ErrNotFound
}

func (m *mockStorageErrorOnExists) DeleteKey(_ context.Context, id string) error {
	return storage.ErrNotFound
}

func (m *mockStorageErrorOnExists) ListKeys(_ context.Context) ([]string, error) {
	return nil, nil
}
...
func (m *mockStorageGetError) Get(_ context.Context, key string) ([]byte, error) {
	return nil, fmt.Errorf("mock Get error")
}

func (m *mockStorageGetError) KeyExists(_ context.Context, id string) (bool, error) {
	return false, nil
}

func (m *mockStorageGetError) SaveKey(_ context.Context, id string, data []byte) error {
	return nil
}

func (m *mockStorageGetError) DeleteKey(_ context.Context, id string) error {
	return storage.ErrNotFound
}

func (m *mockStorageGetError) ListKeys(_ context.Context) ([]string, error) {
	return nil, nil
}
...
func TestListKeys_EdgeCases(t *testing.T) {
	...
	t.Run("ShortKeyID", func(t *testing.T) {
		...
		shortID := "short"
		err := storage.SaveKey(context.Background(), be.storage, shortID, []byte("dummy"))
		if err != nil {
			t.Fatalf("SaveKey failed: %v", err)
		}
