...
// Returns nil if the curve name is not recognized.
func ParseCurve(curveName string) elliptic.Curve {
...
// Returns x509.UnknownPublicKeyAlgorithm if the string is not recognized.
func ParseKeyAlgorithm(s string) x509.PublicKeyAlgorithm {
	s = strings.ToLower(strings.TrimSpace(s))
	switch s {
