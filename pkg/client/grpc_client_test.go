...
func TestGRPCClient_NotConnected(t *testing.T) {
	cfg := &Config{
		Address:  "localhost:9090",
		Protocol: "grpc",
	}
...
func TestGRPCClient_Connect_TLS_CAFileError(t *testing.T) {
	cfg := &Config{
		Address:    "localhost:9090",
		Protocol:   "grpc",
		TLSEnabled: true,
...
func TestGRPCClient_Connect_TLS_InvalidCA(t *testing.T) {
...
func TestGRPCClient_Connect_TLS_CertError(t *testing.T) {
	cfg := &Config{
		Address:     "localhost:9090",
		Protocol:    "grpc",
		TLSEnabled:  true,
...
func TestGRPCClient_Connect_NoTLS_Timeout(t *testing.T) {
	cfg := &Config{
	...
	err = client.Connect(ctx)
	// Should fail because the health check fails (no server running)
	if err == nil {
		t.Error("Connect() should error when health check fails")
	}
}
