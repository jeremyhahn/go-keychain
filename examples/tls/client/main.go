...
// Package main demonstrates creating a TLS client using the xkms.
package main
...
func createClientCertificate(ks xkms.Backend, caCert *x509.Certificate, caSigner crypto.Signer) *x509.Certificate {
