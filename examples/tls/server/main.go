...
// Package main demonstrates creating a TLS server using the xkms.
package main
...
func main() {
	...
	fmt.Println("3. Loading TLS certificate from xkms...")
...
func createCA(ks xkms.Backend) (*x509.Certificate, interface{}) {
...
func createServerCertificate(ks xkms.Backend, caCert *x509.Certificate, caPrivKey interface{}) *x509.Certificate {
