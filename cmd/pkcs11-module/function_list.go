...
// Package main provides PKCS#11 function list structures for the shared library.
//
...
extern CK_RV C_EncapsulateKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount, CK_OBJECT_HANDLE_PTR phKey, CK_BYTE_PTR pCiphertext, CK_ULONG_PTR pulCiphertextLen);
extern CK_RV C_DecapsulateKey(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulCount, CK_BYTE_PTR pCiphertext, CK_ULONG ulCiphertextLen, CK_OBJECT_HANDLE_PTR phKey);

// PKCS#11 v3.2 signature-first verification functions
extern CK_RV C_VerifySignatureInit(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hKey, CK_BYTE_PTR pSignature, CK_ULONG ulSignatureLen);
extern CK_RV C_VerifySignature(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pData, CK_ULONG ulDataLen);
extern CK_RV C_VerifySignatureUpdate(CK_SESSION_HANDLE hSession, CK_BYTE_PTR pPart, CK_ULONG ulPartLen);
extern CK_RV C_VerifySignatureFinal(CK_SESSION_HANDLE hSession);

// PKCS#11 v3.2 session validation functions
extern CK_RV C_GetSessionValidationFlags(CK_SESSION_HANDLE hSession, CK_SESSION_VALIDATION_FLAGS_TYPE type, CK_FLAGS_PTR pFlags);

// PKCS#11 v3.2 async operation functions
extern CK_RV C_AsyncComplete(CK_SESSION_HANDLE hSession, CK_UTF8CHAR_PTR pFunctionName, CK_ASYNC_DATA_PTR pResult);
extern CK_RV C_AsyncGetID(CK_SESSION_HANDLE hSession, CK_UTF8CHAR_PTR pFunctionName, CK_ULONG_PTR pulID);
extern CK_RV C_AsyncJoin(CK_SESSION_HANDLE hSession, CK_UTF8CHAR_PTR pFunctionName, CK_ULONG ulID, CK_BYTE_PTR pData, CK_ULONG ulData);

// PKCS#11 v3.2 authenticated wrapping functions
extern CK_RV C_WrapKeyAuthenticated(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hWrappingKey, CK_OBJECT_HANDLE hKey, CK_BYTE_PTR pAssociatedData, CK_ULONG ulAssociatedDataLen, CK_BYTE_PTR pWrappedKey, CK_ULONG_PTR pulWrappedKeyLen);
extern CK_RV C_UnwrapKeyAuthenticated(CK_SESSION_HANDLE hSession, CK_MECHANISM_PTR pMechanism, CK_OBJECT_HANDLE hUnwrappingKey, CK_BYTE_PTR pAssociatedData, CK_ULONG ulAssociatedDataLen, CK_BYTE_PTR pWrappedKey, CK_ULONG ulWrappedKeyLen, CK_ATTRIBUTE_PTR pTemplate, CK_ULONG ulAttributeCount, CK_OBJECT_HANDLE_PTR phKey);

// Static function list for PKCS#11 v2.x compatibility
static CK_FUNCTION_LIST functionList = {
    {2, 40},  // version: PKCS#11 v2.40
    C_Initialize,
    C_Finalize,
    C_GetInfo,
    C_GetFunctionList,
...
// Static function list for PKCS#11 v3.2
static CK_FUNCTION_LIST_3_2 functionList32 = {
    {3, 2},  // version: PKCS#11 v3.2
    C_Initialize,
    C_Finalize,
    C_GetInfo,
    C_GetFunctionList,
    ...
    C_VerifyMessageNext,
    C_MessageVerifyFinal,
    // PKCS#11 3.2 KEM functions
    C_EncapsulateKey,
    C_DecapsulateKey,
    // PKCS#11 3.2 signature-first verification functions
    C_VerifySignatureInit,
    C_VerifySignature,
    C_VerifySignatureUpdate,
    C_VerifySignatureFinal,
    // PKCS#11 3.2 session validation functions
    C_GetSessionValidationFlags,
    // PKCS#11 3.2 async operation functions
    C_AsyncComplete,
    C_AsyncGetID,
    C_AsyncJoin,
    // PKCS#11 3.2 authenticated wrapping functions
    C_WrapKeyAuthenticated,
    C_UnwrapKeyAuthenticated
};

// getFunctionList32Ptr returns a pointer to the PKCS#11 v3.2 function list
CK_FUNCTION_LIST_3_2_PTR getFunctionList32Ptr() {
    return &functionList32;
}

// Interface name for PKCS#11
static CK_UTF8CHAR pkcs11InterfaceName[] = "PKCS 11";

// Static interface structure for PKCS#11 v2.x (CK_FUNCTION_LIST)
static CK_INTERFACE pkcs11InterfaceV2 = {
    pkcs11InterfaceName,
    &functionList,
    0  // flags
};

// Static interface structure for PKCS#11 v3.0 (CK_FUNCTION_LIST_3_0)
static CK_INTERFACE pkcs11InterfaceV30 = {
    pkcs11InterfaceName,
    &functionList30,
    0  // flags
};

// Static interface structure for PKCS#11 v3.2 (CK_FUNCTION_LIST_3_2)
...
// getInterfacePtr returns a pointer to the v3.2 interface structure (default/latest)
CK_INTERFACE_PTR getInterfacePtr() {
    return &pkcs11Interface;
}

// getInterfaceV2Ptr returns a pointer to the v2.x interface structure
CK_INTERFACE_PTR getInterfaceV2Ptr() {
    return &pkcs11InterfaceV2;
}

// getInterfaceV30Ptr returns a pointer to the v3.0 interface structure
CK_INTERFACE_PTR getInterfaceV30Ptr() {
    return &pkcs11InterfaceV30;
}
*/
import "C"
...
// GetFunctionList32Ptr returns the PKCS#11 v3.2 function list pointer.
// This is used by the C_GetInterface export for v3.2 compatibility.
func GetFunctionList32Ptr() C.CK_FUNCTION_LIST_3_2_PTR {
	return C.getFunctionList32Ptr()
}

// GetInterfacePtr returns the v3.2 (default/latest) interface structure pointer.
// This is used by C_GetInterface export when no version is specified or v3.2 is requested.
func GetInterfacePtr() C.CK_INTERFACE_PTR {
	return C.getInterfacePtr()
}

// GetInterfaceV2Ptr returns the v2.x interface structure pointer.
// This is used by C_GetInterface export for v2.x version requests.
func GetInterfaceV2Ptr() C.CK_INTERFACE_PTR {
	return C.getInterfaceV2Ptr()
}

// GetInterfaceV30Ptr returns the v3.0 interface structure pointer.
// This is used by C_GetInterface export for v3.0 version requests.
func GetInterfaceV30Ptr() C.CK_INTERFACE_PTR {
	return C.getInterfaceV30Ptr()
}
