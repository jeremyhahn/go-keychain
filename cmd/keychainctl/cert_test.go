...
func (m *mockCertClient) ListBackends(ctx context.Context) (*client.ListBackendsResponse, error) {
...
func (m *mockCertClient) ListKeys(ctx context.Context, backend string) (*client.ListKeysResponse, error) {
...
func (m *mockCertClient) ListKeyVersions(ctx context.Context, req *client.ListKeyVersionsRequest) (*client.ListKeyVersionsResponse, error) {
	return &client.ListKeyVersionsResponse{KeyID: req.KeyID}, nil
}

func (m *mockCertClient) EnableKeyVersion(ctx context.Context, req *client.EnableKeyVersionRequest) (*client.EnableKeyVersionResponse, error) {
	return &client.EnableKeyVersionResponse{KeyID: req.KeyID, Version: req.Version}, nil
}

func (m *mockCertClient) DisableKeyVersion(ctx context.Context, req *client.DisableKeyVersionRequest) (*client.DisableKeyVersionResponse, error) {
	return &client.DisableKeyVersionResponse{KeyID: req.KeyID, Version: req.Version}, nil
}

func (m *mockCertClient) EnableAllKeyVersions(ctx context.Context, req *client.EnableAllKeyVersionsRequest) (*client.EnableAllKeyVersionsResponse, error) {
	return &client.EnableAllKeyVersionsResponse{KeyID: req.KeyID}, nil
}

func (m *mockCertClient) DisableAllKeyVersions(ctx context.Context, req *client.DisableAllKeyVersionsRequest) (*client.DisableAllKeyVersionsResponse, error) {
	return &client.DisableAllKeyVersionsResponse{KeyID: req.KeyID}, nil
}
...
func (m *mockCertClient) ListCertificates(ctx context.Context, backend string) (*client.ListCertificatesResponse, error) {
...
func (m *mockCertClient) ListUsers(ctx context.Context) (*client.ListUsersResponse, error) {
