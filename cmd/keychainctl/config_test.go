...
func TestConfig_CreateClientFromProtocol_Embedded(t *testing.T) {
	...
	// Reset keychain service before test
	keychain.Reset()
...
// configTestBackend implements types.Backend for config tests
...
// ============================================================================
// createKeychainService tests
// ============================================================================

func TestConfig_createKeychainService_Success(t *testing.T) {
	tmpDir := t.TempDir()
	...
	svc, err := cfg.createKeychainService()
	if err != nil {
		t.Fatalf("createKeychainService() returned error: %v", err)
	}
	if svc == nil {
		t.Fatal("createKeychainService() returned nil service")
	}
...
func TestConfig_createKeychainService_InvalidKeyDir(t *testing.T) {
	cfg := NewConfig()
	...
	_, err := cfg.createKeychainService()
	if err == nil {
		t.Fatal("createKeychainService() should return error for invalid KeyDir")
	}
}

func TestConfig_createKeychainService_InvalidCertPath(t *testing.T) {
	cfg := NewConfig()
	...
	_, err := cfg.createKeychainService()
	if err == nil {
		t.Fatal("createKeychainService() should return error for invalid cert path")
	}
}

func TestConfig_createKeychainService_ResetsPreviousService(t *testing.T) {
	tmpDir := t.TempDir()
	...
	svc1, err := cfg.createKeychainService()
	if err != nil {
		t.Fatalf("createKeychainService() first call returned error: %v", err)
	}
	if svc1 == nil {
		t.Fatal("createKeychainService() first call returned nil")
	}
	...
	svc2, err := cfg2.createKeychainService()
	if err != nil {
		t.Fatalf("createKeychainService() second call returned error: %v", err)
	}
	if svc2 == nil {
		t.Fatal("createKeychainService() second call returned nil")
	}
...
func TestConfig_createKeychainService_DifferentBackendNames(t *testing.T) {
	testCases := []struct {
		name    string
		backend string
	}{
