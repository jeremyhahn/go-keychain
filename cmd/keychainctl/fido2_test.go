...
func TestDefaultFIDO2HandlerFactory_DefaultEnumerator(t *testing.T) {
	// Test that the default path (non-virtual) works
	config := &fido2.Config{}

	// The factory should create a handler with the default enumerator
...
func TestDefaultFIDO2HandlerFactory_VirtualEnumerator(t *testing.T) {
	...
	// Set the environment variable to enable virtual mode
	...
	// The factory should create a handler with the virtual enumerator
	handler, err := defaultFIDO2HandlerFactory(config)
	if err != nil {
...
func TestDefaultFIDO2HandlerFactory_VirtualEnumeratorFalse(t *testing.T) {
	...
	// Set the environment variable to false (should use default enumerator)
...
func TestDefaultFIDO2HandlerFactory_VirtualEnumeratorOtherValue(t *testing.T) {
	...
	// The factory should create a handler with the default enumerator (not virtual)
	handler, err := defaultFIDO2HandlerFactory(config)
	if err != nil {
		t.Fatalf("defaultFIDO2HandlerFactory failed: %v", err)
	}
