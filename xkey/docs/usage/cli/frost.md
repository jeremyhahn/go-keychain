...
**Syntax:**
```bash
xkmsctl frost import --package <file>
```
...
xkmsctl frost import --package ./alice_participant_1.json
```
...
# JSON format
xkmsctl frost list --format json
```
...
**Syntax:**
```bash
xkmsctl frost info <key-id> [flags]
```
...
```bash
# Basic info
xkmsctl frost info corp-signing-key

# Include public key
xkmsctl frost info corp-signing-key --show-public-key
```
...
**Syntax:**
```bash
xkmsctl frost delete <key-id> [flags]
```
...
xkmsctl frost delete old-key

# Force delete without confirmation
xkmsctl frost delete old-key --force
```
...
**Syntax:**
```bash
xkmsctl frost round1 -k <key-id> -o <output-file>
```
...
xkmsctl frost import --package bob_participant_2.json

# Charlie imports his package
xkmsctl frost import --package charlie_participant_3.json
```
