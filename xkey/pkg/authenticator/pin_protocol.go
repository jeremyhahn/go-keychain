...
//   - PIN Protocol 2: Adds HKDF key derivation and uses AES-256-CBC with random IV
//
...
type PINProtocol interface {
	...
	// For PIN Protocol 2, this uses AES-256-CBC with a random IV prepended to the ciphertext.
...
const (
	...
	// ECDH + HKDF-SHA-256 + AES-256-CBC with random IV + HMAC-SHA-256.
