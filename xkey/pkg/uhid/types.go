...
// AuthenticatorDeviceName is the canonical device name used across all FIDO2
// virtual authenticator surfaces (UHID, native device, GUI status).
const AuthenticatorDeviceName = "xKey OTP+FIDO+CCID"
...
const (
	...
	ProductIDVirtualFIDO uint16 = 0x0001
...
func DefaultCreateConfig() *CreateConfig {
	return &CreateConfig{
		Name:             AuthenticatorDeviceName,
		Phys:             "xkey-authenticator",
		Uniq:             "XKEY001",
