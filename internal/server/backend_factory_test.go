...
func TestInitialize_WithPKCS8Backend(t *testing.T) {
	...
	ks, err := keychain.GetBackend("pkcs8")
	assert.NoError(t, err)
	assert.NotNil(t, ks)
...
func TestInitialize_WithSoftwareBackend(t *testing.T) {
	...
	ks, err := keychain.GetBackend("software")
	assert.NoError(t, err)
	assert.NotNil(t, ks)
...
func TestInitialize_WithAESBackend(t *testing.T) {
	...
	ks, err := keychain.GetBackend("aes")
	assert.NoError(t, err)
	assert.NotNil(t, ks)
...
func TestInitialize_WithMultipleBackends(t *testing.T) {
	...
	defaultKS, err := keychain.GetDefaultBackend()
	assert.NoError(t, err)
...
func TestBackendFactory_Integration(t *testing.T) {
	...
	pkcs8KS, err := keychain.GetBackend("pkcs8")
	require.NoError(t, err)

	softwareKS, err := keychain.GetBackend("software")
	require.NoError(t, err)
...
func TestBackendFactory_SharedCertStorage(t *testing.T) {
	...
	pkcs8KS, _ := keychain.GetBackend("pkcs8")
	softwareKS, _ := keychain.GetBackend("software")
