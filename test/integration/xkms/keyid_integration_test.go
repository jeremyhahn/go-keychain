...
func TestKeyID_NewKeyID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			keyID, err := xkms.NewKeyID(tt.backend, tt.keyType, tt.algo, tt.keyname)
...
func TestKeyID_ValidateKeyID(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			err := xkms.ValidateKeyID(tt.keyID)
...
func TestKeyID_AllKeyTypes(t *testing.T) {
	...
	for _, keyType := range keyTypes {
		t.Run(keyType, func(t *testing.T) {
			keyID, err := xkms.NewKeyID("software", keyType, "rsa", "test-key")
			if err != nil {
				t.Errorf("Failed to create Key ID for key type %s: %v", keyType, err)
			}

			err = xkms.ValidateKeyID(string(keyID))
			if err != nil {
...
func TestKeyID_AllAlgorithms(t *testing.T) {
	...
	for _, algo := range algorithms {
		t.Run(algo, func(t *testing.T) {
			keyID, err := xkms.NewKeyID("software", "signing", algo, "test-key")
			if err != nil {
...
func TestKeyID_AllBackends(t *testing.T) {
	...
	for _, backend := range backends {
		t.Run(backend, func(t *testing.T) {
			keyID, err := xkms.NewKeyID(backend, "signing", "rsa", "test-key")
			if err != nil {
